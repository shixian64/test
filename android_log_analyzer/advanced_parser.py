...
class AdvancedLogParser:
    ...
    CRITICAL_FILES = {
        'android_main', 'android_system', 'kernel', 'lastlog', 'lastkmsg'
    }
    ...
    def _generate_summary(self, analysis_results: Dict[str, Any]) -> Dict[str, Any]:
        ...
        if summary['critical_issues'] > 0:
            summary['recommendations'].append("Critical issues found - immediate attention required")
        
        if summary['total_issues'] > 100:
            summary['recommendations'].append("High issue count - consider system stability review")
