...
class IssuePriorityScorer:
    ...
    def __init__(self, factors: Optional[PriorityFactors] = None):
        ...
        self.severity_scores = {"critical": 100, "high": 75, "medium": 50, "low": 25}

    def calculate_priority(
        self, issue: Dict[str, Any], context: Optional[IssueContext] = None
    ) -> Dict[str, Any]:
    ...
    def batch_prioritize(
        self, issues: List[Dict[str, Any]], context: Optional[IssueContext] = None
    ) -> List[Dict[str, Any]]:
