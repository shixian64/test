...
class CrashClassifier:
    ...
    def __init__(self, model_path: Optional[Path] = None):
        ...
        self.crash_patterns = {
            ...
            "oom": [r"OutOfMemoryError", r"Low memory killer", r"killed.*oom"],
            "system_crash": [
        ...
        self.severity_indicators = {
            ...
            "medium": ["exception", "error", "crash", "killed"],
        ...
        if ML_AVAILABLE:
            ...
            logger.warning(
                "ML libraries not available, using rule-based classification"
            )
    ...
    def _generate_synthetic_training_data(self) -> List[Tuple[str, str]]:
        ...
        java_samples = [
            ...
            (
                "AndroidRuntime: FATAL EXCEPTION: java.lang.IllegalStateException",
                "java_exception",
            ),
