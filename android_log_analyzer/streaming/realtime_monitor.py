    ...
    def get_status(self) -> Dict[str, Any]:
        ...
        status = {
            ...
            'components': {
                ...
                'alert_manager': 'initialized' if self.alert_manager else 'not_initialized'
            },
        ...
        if self.stats['start_time']:
            status['stats']['uptime_seconds'] = (datetime.now() - self.stats['start_time']).total_seconds()
    ...
    def _update_metrics(self):
        ...
        try:
            metrics = {
                ...
                'processor_metrics': self.processor.get_metrics().__dict__ if self.processor else {},
                'alert_stats': self.alert_manager.get_alert_statistics() if self.alert_manager else {}
            }
    ...
    def _on_analysis(self, analysis_result: Dict[str, Any]):
        ...
        try:
            ...
            if analysis_result.get('patterns_detected'):
                logger.debug(f"Patterns detected: {analysis_result['patterns_detected']}")
