...
from .processors.stream_processor import (
    StreamProcessor,
    ProcessorConfig,
    Alert,
    AlertLevel,
...
def check_streaming_health():
    ...
    try:
        ...
        health_status["components"]["adb"] = {"status": "error", "message": str(e)}
        health_status["overall_status"] = "degraded"
    ...
    try:
        ...
        health_status["components"]["collector"] = {"status": "error", "error": str(e)}
    ...
    try:
        ...
        health_status["components"]["processor"] = {"status": "error", "error": str(e)}
        health_status["overall_status"] = "error"
...
def demo_streaming_features():
    ...
    """
    demo_results = {"streaming_available": True, "features_tested": {}}
...
def create_production_monitor(
    device_id: str = None, enable_email: bool = False, email_config: dict = None
) -> RealTimeMonitor:
    """
    ...
    if enable_email and email_config:
        notification_configs.append(
            NotificationConfig(
                channel=NotificationChannel.EMAIL, enabled=True, config=email_config
            )
        )
